        ...
        <div className="mt-2 rounded-lg bg-gray-50 border border-gray-100 px-4 py-3 space-y-2">
          ...
          {steps.map((s, i) => (
            <div key={i} className="flex items-start gap-2.5 text-xs text-gray-600">
              <span className="shrink-0 w-4 h-4 rounded-full bg-gray-200 text-gray-600 flex items-center justify-center font-bold text-[9px]">
                {i + 1}
              </span>
              {s}
            </div>
...
export default function FeaturesPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      {/* Plan comparison lives on /pricing */}
        ...
        <div className="max-w-6xl mx-auto px-6 pb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              ...
              description="The documentation safety net for AI-native teams. Detects PRs authored by Copilot, Cursor, Devin, or Claude via four independent signals — then opens and merges the documentation fix automatically when CI passes. The fix PR body records exactly which signal triggered it."
              bullets={[
                "Detects: bot sender · branch prefix · PR body marker · custom pattern",
                "Auto-merges via squash, merge commit, or rebase — your choice",
                "Pre-validates repo merge method before CI wait — no silent 405 errors",
                "AI Authorship Signal row in every fix PR for full traceability",
                "CI gate: auto-merge skipped if checks fail; fix PR stays open for review",
                "Falls back to inbox triage when AI Author Mode is off",
              ]}
            />
            <FeatureCard
              icon={GitPullRequest}
            ...
            <FeatureCard
              ...
              description="Instead of flagging a problem and leaving, DocuGardener generates the exact Markdown update — Apply Suggestion directly in the PR or let it open an auto-fix PR."
              bullets={[
                "Precise Markdown diff, not generic advice",
                "Apply as GitHub suggestion in one click",
                "Auto-fix PR opens for team review",
                "Confidence score (0–100) on every suggestion",
                "Recheck verification pass before fix is surfaced",
              ]}
            />
            <FeatureCard
              icon={Terminal}
              ...
              bullets={[
                ...
                "Single API key setup — no tenant ID required",
              ]}
            />
            <FeatureCard
              icon={GitBranch}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              ...
              bullets={[
                ...
                "Policy rule named in GitHub check-run output",
                "Policy violations surfaced in Triage Inbox",
            ...
            <FeatureCard
              ...
              bullets={[
                ...
                "Top risk zones ranked by severity and volume",
            ...
            <FeatureCard
              ...
              badge="Pro+"
              title="Audit Log"
              description="Every security-relevant action — logins, triage decisions, settings changes, role modifications — is recorded with a tamper-evident SHA-256 hash chain. CSV / JSON evidence export for compliance packages is available on Team."
              bullets={[
                "SHA-256 hash chain — every record verifiable",
                "18 event types tracked",
                "Evidence timeline with per-repo and per-actor filters",
                "Dismiss-rate breakdown by severity",
            ...
            <FeatureCard
              ...
              badge="All plans"
              title="RBAC"
              description="Four built-in roles — Admin, Member, Auditor, and Billing Admin. Admins manage repos and team. Auditors get read-only access to the audit log. Billing Admins manage plan and budget without full admin access."
              bullets={[
            ...
            <FeatureCard
              ...
              description="Enterprise identity integration via SAML SSO and SCIM 2.0. Automate user provisioning and deprovisioning from your identity provider. Sessions can be revoked centrally."
              bullets={[
                "SAML SSO login",
            ...
            <FeatureCard
              ...
              description="Export the complete audit log as CSV or JSON for a specified date range and event filter. Rate-limited and access-controlled. Designed for compliance evidence packages."
              bullets={[
            ...
            <FeatureCard
              ...
              bullets={[
                "Platform — DocuGardener-hosted LLM, zero config",
                "BYOK Cloud — your OpenAI / Anthropic / Vertex key",
                "BYOK Local — Ollama, zero data leaves your network",
                "Sovereign — self-hosted stack, full data control",
          ...
          <GroupLabel>Agent Governance</GroupLabel>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard
              icon={Bot}
              iconBg="bg-violet-50"
              ...
              description="Keep every AI coding agent aligned with your documentation policy — automatically. DocuGardener compiles your policy into native instruction files for 4 agent ecosystems. When policy changes, a staleness check flags affected repos and one click proposes the update PR."
              bullets={[
                "AGENTS.md — Claude Code, Gemini CLI, generic agent frameworks",
                ".github/copilot-instructions.md — GitHub Copilot",
                ".cursor/rules/docugardener.mdc — Cursor AI",
                "CLAUDE.md — Claude Code project instructions",
                "Nightly staleness cron detects policy drift per format",
                "One-click Propose opens a GitHub PR with the exact diff",
                "Preview compiled output inline before proposing",
                "Bulk 'Propose all stale' across all connected repos",
              ]}
            />
          </div>
