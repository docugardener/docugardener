    ...
    <>
      ...
      <table className="w-full text-sm border-collapse mb-6">
        <tbody>
          ...
          <EnvVar name="PLATFORM_LLM_MONTHLY_CAP_USD" description="Operator-wide platform LLM cost ceiling in USD across all tenants combined. Applies only when BUNDLED_GEMINI_KEY is set. Default: 10.0. Set to 0 to disable the cap." example="PLATFORM_LLM_MONTHLY_CAP_USD=10.0" />
