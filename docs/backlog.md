...
| QA-04 | Owner Console verification on VPS: log in to /admin/owner on docugardener.dev, verify KPI cards, tenant health, override panel, Stripe event feed all render without errors | S | P1 | todo | — | — |
